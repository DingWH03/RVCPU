...
_start:
    ...
    li      a0, 0x80000000      # DRAM 起始地址
    li      a1, 0x50000000      # UART 起始地址
...
00000000 <_start>:
    ...
    4:        80000537        lui x10 0x80000
    8:        500005b7        lui x11 0x50000
    c:        12345337        lui x6 0x12345
    10:        67830313        addi x6 x6 1656
    14:        00000393        addi x7 x0 0
    18:        00002e37        lui x28 0x2
    1c:        710e0e13        addi x28 x28 1808

00000020 <write_loop>:
    20:        0062a023        sw x6 0 x5
    24:        0002a383        lw x7 0 x5
    28:        00730463        beq x6 x7 8 <correct>
    2c:        01c0006f        jal x0 28 <error>

00000030 <correct>:
    30:        00428293        addi x5 x5 4
    34:        fffe0e13        addi x28 x28 -1
    38:        fe0e14e3        bne x28 x0 -24 <write_loop>
    3c:        00052603        lw x12 0 x10
...
```text
800002b7 80000537 500005b7 12345337 67830313 00000393 00002e37 710e0e13  
0062a023 0002a383 00730463 01c0006f 00428293 fffe0e13 fe0e14e3 00052603  
00c5a023 00000013 00000013
```
